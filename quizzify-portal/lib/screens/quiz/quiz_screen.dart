...
//             ),
//             decoration: const ShapeDecoration(
//               shape: StadiumBorder(side: BorderSide(color: kOnSurfaceTextColor, width: 2)),
//             ),
//           ),
//           showActionIcon: true,
//           titleWidget: Obx(() => Text(
...
//               children: [
//                 if (controller.loadingStatus.value == LoadingStatus.loading)
//                   const Expanded(child: ContentArea(child: QuizScreenPlaceHolder())),
//                 if (controller.loadingStatus.value == LoadingStatus.completed)
//                   Expanded(
//                     child: ContentArea(
//                       child: SingleChildScrollView(
...
class _QuizScreenState extends State<QuizeScreen> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.paused || state == AppLifecycleState.inactive) {
      // Auto-submit the quiz if the user switches tabs or minimizes the app
