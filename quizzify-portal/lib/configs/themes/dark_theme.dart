...
const Color kPrimayColorDT = Color.fromARGB(255, 84, 255, 229);
const Color kPrimayLightColorDT = Color.fromARGB(255, 156, 255, 240);
...
class DarkTheme with SubThemeData {
  ThemeData buildDarkTheme() {
    ...
    return systemDarkTheme.copyWith(
        ...
        textTheme: getTextThemes().apply(bodyColor: mainTextColorDT, displayColor: mainTextColorDT),
