...
const Color kPrimayLightColorLT = Color.fromARGB(255, 84, 255, 229);
const Color kPrimayColorLT = Color.fromARGB(255, 84, 255, 229);
...
class LightTheme with SubThemeData {
  ThemeData buildLightTheme() {
    ...
    return systemLightTheme.copyWith(
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(style: getElavatedButtonTheme()),
        cardColor: cardColorLT,
        colorScheme: ColorScheme.fromSwatch(accentColor: kPrimayColorLT, primarySwatch: Colors.purple));
  }
}
